...
export default function Page() {
    return (
        <Flex vertical={false} >
            <Flex style={{ width: '50vw', backgroundColor: '#49d' }} vertical align="center" justify="space-evenly">
            ...
            <Carousel style={{ width: '50vw' }} autoplay>
                <div>
                    <Image style={{ width: '100%', height: '100vh' }} alt="room1" src={room1} />
                </div>
                <div>
                    <Image style={{ width: '100%', height: '100vh' }} alt="room2" src={room2} />
                </div>
                <div>
                    <Image style={{ width: '100%', height: '100vh' }} alt="room3" src={room3} />
                </div>
                <div>
                    <Image style={{ width: '100%', height: '100vh' }} alt="room3" src={room4} />
                </div>
            </Carousel>
        </Flex>
    )
